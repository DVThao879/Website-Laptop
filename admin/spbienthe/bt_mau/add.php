<main class="content px-3 py-4">
    <div class="container-fluid">
        <div class="mb-3">
            ...
            <h3 class="fw-bold fs-4 mt-3">THÊM MỚI MÀU</h3>
            <div class="row">
                <div class="col-12">
                    <form action="index.php?act=addmau" method="post">
                        <div class="mb-3">
                            <label for="" class="form-label">Tên màu</label>
                            <input type="text" class="form-control" name="mausp" placeholder="Nhập màu..." required>
                        </div>
                        <button class="btn btn-outline-primary my-2" type="submit" name="themmau">Thêm mới</button>
