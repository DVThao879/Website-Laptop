<main class="content px-3 py-4">
    <div class="container-fluid">
        <div class="mb-3">
            ...
            <h3 class="fw-bold fs-4 mt-3">THÊM MỚI RAM</h3>
            <div class="row">
                <div class="col-12">
                    <form action="index.php?act=addram" method="post">
                        <div class="mb-3">
                            <label for="" class="form-label">Tên ram</label>
                            <input type="text" class="form-control" name="ramsp" placeholder="Nhập tên ram..." required>
                        </div>
                        <button class="btn btn-outline-primary my-2" type="submit" name="themram">Thêm mới</button>
