<div class="container mt-5 chitietsp">
    <h3 class="border-bottom pb-3 mb-2"><?php echo $onesp['name'] ?></h3>
    <div class="row mb-2">
        <div class="col-xxl-6">
            <div class="box-left d-flex gap-5">
                <div>
                    <img src="../upload/<?php echo $onesp['img'] ?>" alt="" class="border img-fluid">
                </div>
                <div class="boxctsp-money">
                    <form action="index.php?act=addtocart" method="post">
                        ...
                        <?php foreach ($onebtram as $spbt) : ?>
                            <span style="me-2"><input type="radio" name="idram" class="ram" value="<?php echo $spbt['id'] ?>"> <?php echo $spbt['ram_sp'] ?></span>
                        <?php endforeach ?>
                        <select name="idmau" class="mau form-select my-3">
                            <option value="">Hãy chọn ram để chọn màu</option>
                        </select>
                        <input type="number" name="soluong" id="sl-input" class="form-control" placeholder="Nhập số lượng" value="1" min="1" required>
                        <p id="sl-hienthi"></p>
                        ...
                        <input type="submit" name="addtocart" onclick="return checksl()" value="Thêm vào giỏ hàng" class="btn btn-success mb-3">
                    </form>
                </div>
            </div>
        </div>
        <div class="col-xxl-6">
            <div class="box-right p-3">
                <div>
                    ...
                    <div class="content-ctsp my-2 p-2">
        ...
        <div class="add-bl">
            <?php if (isset($_SESSION['user'])) : ?>
                <form action="index.php?act=sanphamct&idsp=<?php echo $onesp['id'] ?>" method="post">
                    ...
                    <span><i class="fa-solid fa-paper-plane text-white"></i><input type="submit" name="guibinhluan" value="Gửi"></span><br><br>
                    <p class="text-danger">
                        <?php
